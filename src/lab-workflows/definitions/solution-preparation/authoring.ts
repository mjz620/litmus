...
export const SOLUTION_PREPARATION_AUTHORING_COMMANDS = Object.freeze([
  ...
  { type: "add_objective", objectiveId: "solution_dilution" },
  {
    ...
    equipment: {
      ...
      label: "0.5000 mol/L sodium chloride stock",
      required: true
    }
  },
  {
  ...
  },
  {
    ...
    rule: {
      ...
      condition: {
        ...
        expectedValue: {
          valueType: "text",
          value: "reagent.sodium_chloride_aqueous.v1"
        }
      },
      severity: "procedural",
      recoverable: true,
